...
public class BoardController {
	 ...
	 * pageNum_cnt));
	 * 
	 * if (endPageNum > endPageNum_tmp) { endPageNum = endPageNum_tmp; } boolean
	 * prev = startPageNum == 1 ? false : true; boolean next = endPageNum *
	 * pageNum_cnt >= count ? false : true; List<BoardVO> list = null; list =
